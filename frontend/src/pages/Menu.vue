            ...
            <div class="col-sm-8">
                ...
                <div class="row box-container">
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <div class="price">
                                    {{ parseFloat(f.food_price) - parseFloat(f.food_discount) }} Ft
                                    <span v-if="parseFloat(f.food_discount) != 0.00">{{ parseFloat(f.food_price)
                                    }} Ft</span>
                                </div>
                                <button class="btn" @click="addItem(index)">Kosárba</button>
                            </div>
                        </div>
                    </div>
                    <div v-if="!filterFoods.length">
                        <div class="box">
                            <div class="content">
                                <h1 style="color: yellow;">Nincs eredmény!</h1>
                            </div>
                            <div class="image">
    ...
    methods: {
        ...
        filterFoodBtn: function (e) {
            ...
            if (this.foodObj.category != e.target.value && this.previousCategoryClicked != "") {
                this.previousCategoryClicked.target.style.background = "yellow";
            }
        ...
        filterStatusBtn: function (e) {
            ...
            if (this.foodObj.status.includes(e.target.value) == false) {
                ...
                document.querySelector(`[for=${e.target.id}]`).style.background = "yellow";
                document.querySelector(`[for=${e.target.id}]`).style.color = "black";
